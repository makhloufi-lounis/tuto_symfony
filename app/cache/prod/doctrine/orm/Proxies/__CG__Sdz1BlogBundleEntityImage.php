...
namespace Proxies\__CG__\Sdz1\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \Sdz1\BlogBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Sdz1\\BlogBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Sdz1\\BlogBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Sdz1\\BlogBundle\\Entity\\Image' . "\0" . 'alt');
        }
